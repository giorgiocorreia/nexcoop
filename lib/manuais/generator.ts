...
async function gerarPDFBuffer(
  ...
  for (const secao of secoes) {
    ...
    for (const paragrafo of secoes[0] === secao ? secao.conteudo : secao.conteudo) {
      ...
      } else if (paragrafo.startsWith('-') && paragrafo !== '---') {
        // Bullet
        const bulletText = paragrafo.slice(1).trim()
      ...
      } else if (paragrafo.startsWith('[ATENCAO]')) {
        // Alerta
        y += 4
        const alertLines = wrapText(paragrafo.replace('[ATENCAO] ', 'Atencao: '), font, 9, CONTENT_W - 20)
  ...
  const secoes = [
    {
      ...
      conteudo: [
        ...
        '[ATENCAO] Posicionamento: o NexCoop não substitui o sistema contábil do escritório. Ele organiza os dados para que o contador trabalhe com eficiência.',
      ],
    },
    {
    ...
    },
    {
      ...
      conteudo: [
        ...
        '[ATENCAO] O fechamento é irreversível. Certifique-se de que todos os lançamentos foram classificados antes de prosseguir.',
    ...
    },
    {
      ...
      conteudo: [
        ...
        '[ATENCAO] O SPED ECD gerado é auxiliar. Deve ser validado pelo contador no programa SPED do governo antes da entrega oficial.',
      ],
    },
    {
  ...
  const secoes = [
    ...
    },
    {
      ...
      conteudo: [
        ...
        '[ATENCAO] Lançamentos registrados no Financeiro são a base da escrituração contábil. Certifique-se de preencher a descrição com clareza para facilitar a classificação pelo contador.',
        '---',
