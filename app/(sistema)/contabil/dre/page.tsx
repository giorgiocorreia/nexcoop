    ...
    <div style={{ padding: 32, maxWidth: 720, margin: '0 auto' }}>
      ...
      {loading ? (
        ...
        <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #e5e3dc', overflow: 'hidden' }}>
          ...
          {resultado && (
            <div style={{
              display: 'flex', justifyContent: 'space-between', padding: '16px 20px', fontSize: 15, fontWeight: 700,
              background: resultado.valor >= 0 ? '#f0fdf9' : '#fef2f2',
              color: resultado.valor >= 0 ? COR : '#dc2626',
            }}>
          ...
          {dados.length === 0 && (
            <div style={{ padding: 40, textAlign: 'center', color: '#6b7280', fontSize: 14 }}>
              Nenhum dado contábil para o exercício {ano}.
            </div>
          )}
        </div>
      )}
