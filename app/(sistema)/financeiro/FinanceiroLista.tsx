...
export default function FinanceiroLista({ lancamentos, nomeCooperado, isParceiro }: Props) {
  ...
  return (
    <>
      <style>{`
        .fin-kpi-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; margin-bottom: 1.5rem; }
        @media (max-width: 640px) { .fin-kpi-grid { grid-template-columns: 1fr 1fr !important; } }
      `}</style>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{
            ...
            <i className="ti ti-receipt-2" style={{ color: '#635BFF', fontSize: 18 }} />
          </div>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <h1 style={{ margin: 0, fontSize: 18, fontWeight: 700, color: '#1a1a1a' }}>Financeiro</h1>
      ...
      {/* ── Conteúdo ───────────────────────────────────────────────────────── */}
      <div className="fin-content" style={{
        background: '#F8F7F4',
