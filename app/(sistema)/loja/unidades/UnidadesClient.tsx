...
import { criarUnidade, toggleUnidade } from '@/lib/loja/unidades-actions'
  ...
  return (
    <div style={{ padding: '24px 32px', maxWidth: 700 }}>
      ...
      <div style={{ background: '#fff', border: '1px solid #e5e3dc', borderRadius: 12, overflow: 'hidden', marginBottom: 12 }}>
        ...
        {ativas.map((u, i) => (
          <div key={u.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '11px 20px', borderBottom: i < ativas.length - 1 ? '1px solid #f5f5f4' : 'none' }}>
