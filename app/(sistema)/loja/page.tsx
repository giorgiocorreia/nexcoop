...
export default async function LojaHubPage() {
  ...
  const kpiCards = [
    ...
    },
    {
      ...
      sub: "Estimado (fundo + dinheiro/pix)",
      icon: "💵",
      success: true,
    },
    {
  ...
  return (
    <div style={{ padding: "24px 32px", maxWidth: 1200 }}>
          ...
          return (
            <div key={card.label} style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 3, minWidth: 0 }}>
                ...
                {card.sub && (
                  <div style={{ fontSize: 11, color: card.alert ? "#DC2626" : "#78716c" }}>
                    {card.sub}
                  </div>
                )}
              </div>
      ...
      {/* Ações rápidas */}
      <div style={{ background: "#fff", border: "1px solid #e5e3dc", borderRadius: 12, padding: "18px 20px" }}>
        <div style={{
          fontSize: 13, fontWeight: 700, textTransform: "uppercase",
          letterSpacing: "0.06em", color: "#78716c", marginBottom: 12,
        }}>Ações rápidas</div>
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          {[
            { label: "Abrir PDV",       icon: "🛒", href: "/loja/pdv",          azul: true  },
            { label: "Nova Compra",     icon: "📥", href: "/loja/compras/nova",  azul: false },
            { label: "Compras",         icon: "📊", href: "/loja/compras",       azul: false },
            { label: "Produtos",        icon: "📦", href: "/loja/produtos",      azul: false },
            { label: "Estoque",         icon: "🏪", href: "/loja/estoque",       azul: false },
            { label: "Fornecedores",    icon: "🚚", href: "/loja/fornecedores",  azul: false },
          ].map((a) => (
            <Link key={a.label} href={a.href} style={{
              ...
              border: a.azul ? "1px solid #378ADD" : "1px solid #d1d5db",
              background: a.azul ? "transparent" : "#fff",
              color: "#374151",
              textDecoration: "none",
            }}>
