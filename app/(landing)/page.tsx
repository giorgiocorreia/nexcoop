...
function Logo() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <span style={{ fontWeight: 700, fontSize: 18, color: GREEN_DARK, letterSpacing: '-0.3px' }}>
        NextCoop
      </span>
    </div>
  )
...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <a
      href={href}
      style={{ color: TEXT, textDecoration: 'none', fontSize: 14, fontWeight: 500, opacity: 0.75 }}
    >
      {children}
    </a>
  )
...
function Hero() {
  return (
    ...
    >
      ...
      >
        Controle filiados, mensalidades, assembleias e documentos em uma plataforma simples,
        segura e feita para o cooperativismo brasileiro.
      </p>
...
const FEATURES = [
  ...
  },
  {
    icon: '💳',
    title: 'Mensalidades',
    desc: 'Geração automática de cobranças e controle de inadimplência em tempo real.',
  },
  {
    icon: '🏛️',
    title: 'Assembleias',
    desc: 'Convocações, registro de atas digitais e controle de presença.',
  },
  {
    icon: '📁',
    title: 'Documentos',
    desc: 'Repositório centralizado com alertas automáticos de vencimento.',
  },
  {
    icon: '💰',
    title: 'Financeiro',
    desc: 'Lançamentos, categorias e visão de fluxo de caixa da cooperativa.',
  },
  {
    icon: '🌱',
    title: 'Projetos Agro',
    desc: 'Captação de recursos e gestão de projetos do agronegócio. Em breve.',
    soon: true,
  },
]
...
const AUDIENCES = [
  {
    icon: '🌾',
    title: 'Cooperativas agropecuárias',
    desc: 'Gestão de filiados, cotas e projetos com rastreabilidade completa para cooperativas de produção rural.',
  },
  {
    icon: '🤝',
    title: 'Associações rurais',
    desc: 'Controle de mensalidades, atas e documentos legais para associações de produtores e trabalhadores rurais.',
  },
  {
    icon: '🏢',
    title: 'Centrais de cooperativas',
    desc: 'Estrutura multi-tenant que permite gerir múltiplas cooperativas afiliadas com dados completamente isolados.',
  },
]
        ...
        >
          {AUDIENCES.map((a) => (
            ...
            >
              ...
              <h3 style={{ fontWeight: 700, fontSize: 18, marginBottom: 10, color: TEXT }}>
                {a.title}
              </h3>
...
function PlanCard({
  ...
  return (
    <div
      style={{
        border: highlight ? `2px solid ${GREEN}` : '1px solid #e8e6e1',
        borderRadius: 16,
        padding: '32px 24px',
        background: highlight ? '#f0faf6' : BG,
        display: 'flex',
    ...
    >
      ...
      <Link
        ...
        style={{
          ...
          border: highlight ? 'none' : `1.5px solid ${GREEN}`,
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, lineHeight: 1.6, maxWidth: 220 }}>
            Gestão cooperativa para o Brasil
          </p>
        </div>
        ...
        <p style={{ fontSize: 12, alignSelf: 'flex-end' }}>
          © 2026 NextCoop. Todos os direitos reservados.
        </p>
      </div>
    </footer>
  )
