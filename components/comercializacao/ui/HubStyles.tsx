export function HubStyles() {
  return (
    <style>{`
      ...
      .com-hub-content { padding: 28px 32px; margin: 0 -2rem -2rem -2rem; background: #F5F8F4; min-height: 100vh; }
      .com-hub-date { font-size: 12px; color: #647365; padding-left: 50px; }
      .com-kpi-grid { display: grid; grid-template-columns: repeat(6, minmax(0,1fr)); gap: 10px; margin-bottom: 24px; }
      .com-kpi-card {
        display: flex; align-items: center; gap: 14px;
        border-radius: 12px; border: 1px solid #DFE6DD;
      ...
      .com-kpi-label { font-size: 11px; font-weight: 600; color: #647365; line-height: 1.3; }
      ...
      .com-link-card { display: flex; align-items: flex-start; gap: 12px; padding: 16px 18px;
        background: #fff; border: 1px solid #DFE6DD; border-radius: 12px; text-decoration: none;
      ...
      .com-section-label { font-size: 11px; font-weight: 700; text-transform: uppercase;
        letter-spacing: 0.08em; color: #647365; margin: 0 0 12px; }
      .com-btn-cta { transition: opacity 0.15s, transform 0.1s; }
      .com-btn-cta:hover { opacity: 0.92; transform: translateY(-1px); }
      .com-guia-card { background: #fff; border: 1px solid #DFE6DD; border-radius: 12px; padding: 16px 18px; }
      ...
      .com-table th { font-size: 10px; font-weight: 700; color: #647365; text-transform: uppercase; letter-spacing: 0.06em; padding: 12px 16px; text-align: left; border-bottom: 1px solid #DFE6DD; background: #F7FAF6; }
